...
namespace Automation
{
    ...
    public class BestWorst : HonbuAutomation
    {
        ...
        public override void Open()
        {
            ...
            Window menuWindow = this.ContinuousGet(() => Window.GetTopChild(menuProcess.Id, "WindowsForms10.Window.8.app4", "服飾販売管理 本部システム"));
            if (menuWindow != null)
            {
            ...
            else
            {
                ...
                menuWindow = this.ContinuousGet(() => Window.GetTopChild(menuProcess.Id, "WindowsForms10.Window.8.app3", "服飾販売管理 本部システム"));
            }
            ...
            Window menu = this.ContinuousGet(() => Window.GetTopChild(menuProcess.Id, "#32768", ""));
            ...
            theWindow = this.ContinuousGet(() => Window.GetTopChild(theProcess.Id, "WindowsForms10.Window.8.app.0.378734a", "売上ベストワースト分析"));
        ...
        public Action SetCutSawn
        {
            get
            {
                return () =>
                {
                    ...
                    Window largeCategory = this.ContinuousGet(() => P01_001.GetChild("WindowsForms10.COMBOBOX.app.0.378734a", "", 4));

                    largeCategory.MouseMove(PointMode.LeftTop, 14, 9, 99);
                    largeCategory.MouseE(MType.Down, MBtn.L, PointMode.LeftTop, 14, 9); Thread.Sleep(410);
                    largeCategory.MouseE(MType.Up, MBtn.L, PointMode.LeftTop, 14, 9); Thread.Sleep(41);

                    Window topsItem = this.ContinuousGet(() => Window.GetTopChild(P01.Id, "ComboLBox", "", 0));
                    
                    this.DoWhenActive(topsItem, null);
                    //for (int i = 0; topsItem == null && i < 3; i++ ) Thread.Sleep(2000);

                    topsItem.MouseMove(PointMode.LeftTop, 29, 34, 76);
                    topsItem.MouseE(MType.Down, MBtn.L, PointMode.LeftTop, 29, 34); Thread.Sleep(160);
                    topsItem.MouseE(MType.Up, MBtn.L, PointMode.LeftTop, 29, 34); Thread.Sleep(160);

                    Window midCategory = this.ContinuousGet(() => P01_001.GetChild("WindowsForms10.COMBOBOX.app.0.378734a", "", 3));

                    midCategory.MouseMove(PointMode.LeftTop, 41, 6, 385);
                    midCategory.MouseE(MType.Click, MBtn.L, PointMode.LeftTop, 41, 6);

                    Window cutItem = this.ContinuousGet(() => Window.GetTopChild(P01.Id, "ComboLBox", "", 0));
        ...
        public Action SetCloth
        {
            get
            {
                return () =>
                {
                    ...
                    Window clothItem = this.ContinuousGet(() => Window.GetTopChild(P01.Id, "ComboLBox", "", 0));
        ...
        public Action SetKnit
        {
            get
            {
                return () =>
                {
                    ...
                    Window knitItem = this.ContinuousGet(() => Window.GetTopChild(P01.Id, "ComboLBox", "", 0));
        ...
        public Action SetSkirt
        {
            get
            {
                return () =>
                {
                    ...
                    Window largeCategory = this.ContinuousGet(() => this.theWindow.GetChild("WindowsForms10.COMBOBOX.app.0.378734a", "", 4));
                    ...
                    Window bottomsItem = this.ContinuousGet(() => Window.GetTopChild(P01.Id, "ComboLBox", "", 0));
                    ...
                    Window midCategory = this.ContinuousGet(() => this.theWindow.GetChild("WindowsForms10.COMBOBOX.app.0.378734a", "", 3));
                    ...
                    Window skirtItem = this.ContinuousGet(() => Window.GetTopChild(P01.Id, "ComboLBox", "", 0));
                    skirtItem = skirtItem.WaitForActive(60000);
        ...
        public Action SetPants
        {
            get
            {
                return () =>
                {
                    ...
                    Window pantsItem = this.ContinuousGet(() => Window.GetTopChild(P01.Id, "ComboLBox", "", 0));
        ...
        public Action SetJacket
        {
            get
            {
                return () =>
                {
                    ...
                    Window outerItem = this.ContinuousGet(() => Window.GetTopChild(P01.Id, "ComboLBox", "", 0));
                    ...
                    Window jacketItem = this.ContinuousGet(() => Window.GetTopChild(P01.Id, "ComboLBox", "", 0));
        ...
        public Action SetOnePiece
        {
            get
            {
                return () =>
                {
                    ...
                    Window onePieceItem = this.ContinuousGet(() => Window.GetTopChild(P01.Id, "ComboLBox", "", 0));
        ...
        protected override void Query()
        {
            ...
            Window startDatePicker = this.ContinuousGet(() => theWindow.GetChild("WindowsForms10.SysDateTimePick32.app.0.378734a", "", 1));
            ...
            Window endDatePicker = this.ContinuousGet(() => theWindow.GetChild("WindowsForms10.SysDateTimePick32.app.0.378734a", "", 0));
            ...
            Window searchButton = this.ContinuousGet(() => this.theWindow.GetChild("WindowsForms10.BUTTON.app.0.378734a", "検索"));
        ...
        public void PrintPreview(Window window, string saveFileName)
        {
            ...
            Window printPreviewButton = this.ContinuousGet(() => window.GetChild("WindowsForms10.BUTTON.app.0.378734a", "印刷"));
        ...
        private void PrintOut()
        {
            ...
            this.WaitForActive();
            Window previewWindow = this.ContinuousGet(() => Window.GetTopChild(P01.Id, new Regex(@"WindowsForms10\.Window\.8\.app\.0\.378734a"), new Regex("売上ベスト・ワースト分析.*印刷プレビュー画面")));

            Window menu = this.ContinuousGet(() => previewWindow.GetChild("WindowsForms10.Window.8.app.0.378734a", ""));
            menu.DoAfterActivated(() =>
            {
                menu = this.ContinuousGet(() => previewWindow.GetChild("WindowsForms10.Window.8.app.0.378734a", ""));
            });

            Window printButton = this.ContinuousGet(() => menu.GetChild("WindowsForms10.Window.8.app.0.378734a", "", 2));

            printButton.DoAfterActivated(null);
        ...
        private void SaveFile(string fileName)
        {
            ...
            Window pdfButton = this.ContinuousGet(() =>  
                previewWindow.GetChild("WindowsForms10.BUTTON.app.0.378734a", "PDF出力"));

            pdfButton.DoAfterActivated(null);
            ...
            Window saveDialog = this.ContinuousGet(() =>
                Window.GetTopChild(P01.Id, "#32770", "保存先を指定してください")
            );
            Console.Write("saveDialogが");
            try
            {
                saveDialog.DoAfterActivated(() =>
                Console.WriteLine("取れたよ")
                );
            }
            catch (Exception ex)
            {
                Console.WriteLine("取れなかったよ");
            }
            ...
            try
            {
                Window name = this.ContinuousGet(() => 
                 saveDialog.GetChild("DUIViewWndClassName", ""));
                Window direct = this.ContinuousGet(() => name.GetChild("DirectUIHWND", ""));
                Window sink = this.ContinuousGet(() => direct.GetChild("FloatNotifySink", "", 0));
                Window combo = this.ContinuousGet(() => sink.GetChild("ComboBox", ""));
                fileNameText = this.ContinuousGet(() => combo.GetChild("Edit", ""));
                fileNameText.DoAfterActivated(null);
            }
            catch
            {
                Window comboEx = this.ContinuousGet(() => saveDialog.GetChild("ComboBoxEx32", ""));
                Window combo = this.ContinuousGet(() => comboEx.GetChild("ComboBox", ""));
                fileNameText = this.ContinuousGet(() => combo.GetChild("Edit", ""));
                fileNameText.DoAfterActivated(null);
            }
       ...
       public void StartPrint()
        {
                ...
                Window printDialog = this.ContinuousGet(() => Window.GetTopChild(P01.Id, "#32770", "印刷"));
                Window printButton = this.ContinuousGet(() => printDialog.GetChild("Button", "OK"));
       ...
       internal new void AnswerDialogOK()
       {
           ...
           Window dialog = this.ContinuousGet(() => Window.GetTopChild(P01.Id, "#32770", "PDF出力"));
       ...
       private void ClosePrintPreview()
       {
           ...
           Window closeButton = this.ContinuousGet(() => previewWindow.GetChild("WindowsForms10.BUTTON.app.0.378734a", "閉じる"));
       ...
       public void PrintImageGallery()
       {
           ...
           Window imageButton = this.ContinuousGet(() => this.theWindow.GetChild("WindowsForms10.BUTTON.app.0.378734a", "画像一覧"));
           ...
           Thread.Sleep(5000);
           this.galleryWindow = this.ContinuousGet(() => Window.GetTopChild(P01.Id, "WindowsForms10.Window.8.app.0.378734a", "売上ベスト・ワースト分析  画像一覧"));

           Window printButton = this.ContinuousGet(() => this.galleryWindow.GetChild("WindowsForms10.BUTTON.app.0.378734a", "印刷"));
           printButton.DoAfterActivated(null);
       ...
       public void CloseImageGallery()
       {
           ...
           Thread.Sleep(5000);
           this.galleryWindow.WaitForActive(10000);
           Window closeButton = this.ContinuousGet(() => this.galleryWindow.GetChild("WindowsForms10.BUTTON.app.0.378734a", "閉じる"));
           closeButton.DoAfterActivated(null);
           closeButton.MouseMove(PointMode.LeftTop, 57, 13, 952);
           closeButton.MouseE(MType.Down, MBtn.L, PointMode.LeftTop, 57, 13);
           Thread.Sleep(400);
           closeButton.MouseE(MType.Up, MBtn.L, PointMode.LeftTop, 57, 13);
       }
        ...
        private void SetSearch50Hits()
        {
            ...
            Window hitsCombo = this.ContinuousGet(() => this.theWindow.GetChild("WindowsForms10.COMBOBOX.app.0.378734a", "", 0));
        ...
        public override void Close()
        {
            ...
            Window closeButton = this.ContinuousGet(() => this.theWindow.GetChild("WindowsForms10.BUTTON.app.0.378734a", "終了"));
            this.WaitForActive();
            this.theWindow.SetFocus();
            closeButton.MouseE(MType.Click, MBtn.L, PointMode.LeftTop, 27, 20);
            Thread.Sleep(1500);

            Window confirm = this.ContinuousGet(() => Window.GetTopChild(P01.Id, "#32770", "確認"));
            confirm.SetForeground();
            Window yesButton = this.ContinuousGet(() => confirm.GetChild("Button", "はい(&Y)"));
